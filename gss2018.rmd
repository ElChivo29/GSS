...
$H_0$ there is a relationship between gun ownership and opinion on the death penalty.

## Methods

<!--Decide on your methods:  use "variable analysis" or other appropriate descriptors.  Make sure to choose at least one graphical method and at least one numerical method.!-->

both variables are categorical so we use cat~cat.
...
colPerc(table1)
```
this summary shows those who own guns.
...
chi-squared test p-value is 0.02022, less than 0.05, so we reject the null hypothesis.

Fisher exact p-value is 0.01651, so we conclude that there is a relationship between gun ownership and opinion on capital punishment. people who own a gun are on average 2.3 times more likely to favor capital punishment than those who do not own a gun.
